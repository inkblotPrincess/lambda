...
namespace lambda::render::opengl
{
    namespace detail
    {
        ...
        auto load_attribute_functions() -> void
        {
            ...
            std::call_once(Flag, [&]() {
                ...
                os::ensure_os(::RegisterClassA(&DummyWC), "Failed to register dummy class");
                ...
                os::ensure_os(DummyHandle, "Failed to create dummy window");
                ...
                os::ensure_os(Format != 0, "Failed to choose pixel format");
                os::ensure_os(::SetPixelFormat(DummyDC, Format, &FormatDesc), "Failed to set pixel format");

                auto RenderingContext = ::wglCreateContext(DummyDC);
                os::ensure_os(RenderingContext, "Failed to create rendering context");
                LAMBDA_DEFER([&DummyDC, &RenderingContext]() { ::wglMakeCurrent(DummyDC, nullptr); ::wglDeleteContext(RenderingContext); });

                os::ensure_os(::wglMakeCurrent(DummyDC, RenderingContext), "Failed to set rendering context");

                wglChoosePixelFormatARB = reinterpret_cast<wglChoosePixelFormatARB_func>(wglGetProcAddress("wglChoosePixelFormatARB"));
                os::ensure_os(wglChoosePixelFormatARB != nullptr, "Failed to load wglChoosePixelFormatARB");

                wglCreateContextAttribsARB = reinterpret_cast<wglCreateContextAttribsARB_func>(wglGetProcAddress("wglCreateContextAttribsARB"));
                os::ensure_os(wglCreateContextAttribsARB != nullptr, "Failed to load wglCreateContextAttribsARB");
            });
        }
    } // namespace detail
    ...
    context::context(os::window& Window)
        : m_State{std::make_unique<context::state>()}
    {
        ...
        os::ensure_os(detail::wglChoosePixelFormatARB(m_State->DeviceContext, FormatDescAttributes, 0, 1, &Format, &FormatCount), "Failed to choose format");
        os::ensure_os(FormatCount != 0, "Failed to get format count");

        auto FormatDesc = ::PIXELFORMATDESCRIPTOR{};
        os::ensure_os(::DescribePixelFormat(m_State->DeviceContext, Format, sizeof(FormatDesc), &FormatDesc), "Failed to describe format");
        os::ensure_os(::SetPixelFormat(m_State->DeviceContext, Format, &FormatDesc), "Failed to set format");
        ...
        os::ensure_os(m_State->RenderingContext, "Failed to create rendering context");
        os::ensure_os(::wglMakeCurrent(m_State->DeviceContext, m_State->RenderingContext), "Failed to set current context");
    }

    auto context::load_function(char const* FunctionName) -> void*
    {
    ...
    {
        os::ensure_os(::SwapBuffers(m_State->DeviceContext), "Failed to swap buffers");
    }
} // namespace lambda::render::opengl